...
ORCHESTRATOR_MODEL = os.environ.get("ORCHESTRATOR_MODEL", "gemini-3.1-flash-lite")  # cheaper: gemini-3.5-flash
WORKER_MODEL = os.environ.get("WORKER_MODEL", "gpt-5.4-mini")  # cheaper: gpt-5.5
