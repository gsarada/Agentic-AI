...
from google.adk.tools.mcp_tool import McpToolset, StdioConnectionParams, StreamableHTTPConnectionParams  # noqa: E402
...
async def judge_game(language: str, objective: str, uri: str) -> dict | None:
    ...
    ##########
    #TODO
    '''This will not work as is because I need to mount the site folder to playwright mcp server so it can access 
     the html files. I need to mount that and update uri to map to container volume name'''
    #############
    browser = McpToolset(
